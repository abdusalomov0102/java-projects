...
public class ModelCard {
    ...
    public String generationAccount() {
        ...
        accountNumber += " " + time.substring(4, 8);
        accountNumber += " " + time.substring(8, 12);
    ...
    public ModelCard(String bankName, String cardSystem, String accountNumber, String expireDate, String owner, double balance, String pincode, boolean block) {
