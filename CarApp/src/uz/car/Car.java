...
public class Car {
    ...
    public Car(String model, String number, String color, double petrolShow, double petrolUse, double petrolTank, double petrolPrice, boolean status) {
        this.model = model;
        this.number = number;
        this.color = color;
    ...
    public void start() {
        if (status) {
            ...
            if (petrolShow < 5) {
                System.out.println("You have " + petrolShow + " litre petrol. \nPlease refill.");
            }
        }
    }
    ...
    public void refill() {
        ...
        System.out.println("0 = Back         1 = By litre         2 = By Money         3 = Full bag");
        ...
        switch (scanner.nextByte()) {
            ...
            case 1:
                ...
                if (petrol < possiblePetrol) {
                    petrolShow += petrol;
                    System.out.println(petrol + " litre is infused. You must to pay " + petrol * petrolPrice + " sum.");
                } else {
                ...
                break;
            case 2:
                System.out.println("Enter amount sum (1 litre - 3000 sum)");
                int money = scanner.nextInt();
                if (money < possiblePetrol * petrolPrice) {
                    petrolShow += money / petrolPrice;
                    System.out.println(money / petrolPrice + " litre is infused. You must to pay " + money + " sum.");
                } else {
                    petrolShow = petrolTank;
                    System.out.println("Petrol Tank is filled.");
                    System.out.println(money / petrolPrice + " litre is infused. You must to pay " + possiblePetrol * petrolPrice + " sum.");
                }
                break;
            case 3:
                petrolShow = petrolTank;
